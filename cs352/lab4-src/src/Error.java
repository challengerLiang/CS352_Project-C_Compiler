...
public abstract class Error {
  ...
  // Expressions
  public static void UndeclaredVariable(Token t, Value v) {
    Err(t, "id '" + v.id + "' is undeclared");
  }
  ...
  public static void WrongTypeBinary(Token t, String op, CType left, CType right) {
   ...
   public static void FunctionRedefinition(Token t, Value.Function func) {
     Err(t, "redeclaration of '" + func.id + "'");
   }

  public static void VariableRedefinition(Token t) {
