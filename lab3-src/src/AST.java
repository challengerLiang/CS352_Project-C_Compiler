...
public abstract class AST {
  ...
  public static class Print implements Visitor<Void> {
    ...
    @Override
    public Void visit(Expression.Star expr) 
    {
        say("*"); print(expr.expr, i);
        return null;
    }
    ...
    @Override
    public Void visit(Expression.EqualRelation expr) 
    {
      visit(expr.left, expr);
      say(" "); say(expr.token); say(" ");
      visit(expr.right, expr);
    ...
    @Override
    public Void visit(Expression.Relational expr) 
    {
      visit(expr.left, expr);
      say(" "); say(expr.token); say(" ");
      visit(expr.right, expr);
    ...
    @Override
    public Void visit(Expression.Additive expr) 
    {
      visit(expr.left, expr);
      say(" "); say(expr.token); say(" ");
      visit(expr.right, expr);
    ...
    @Override
    public Void visit(Expression.Multiplicative expr) 
    {
      visit(expr.left, expr);
      say(" "); say(expr.token); say(" ");
      visit(expr.right, expr);
    ...
    @Override
    public Void visit(Expression.Double2 expr) {
      say(String.valueOf(expr.value));
      return null;
    }
    ...
    @Override
    public Void visit(Expression.Func func) {
      say(func.id);

      if (func.list_args2 == null ||
          func.list_args2.size() == 0)
      {
        say("()");
      } 
      else 
      {
        say("(");
        int argIndex = 0;
        for (Expression arg : func.list_args2) 
        {
          print(arg, i + 4);
          if (argIndex++ < func.list_args2.size() - 1)
            say(", ");
        }
          say(")");
      }
    ...
    @Override
    public Void visit(Expression.Str expr) {
      say(expr.str);
      return null;
    }
    ...
    public Void visit(Statement.IfStatement iStmt) {
      indent(i); say("if (");
      print(iStmt.cond, i + 2);
      sayln(")");
      print(iStmt.body, i + 2);
      if (iStmt.elseStmt != null)
      {
          indent(i); sayln("else");
          print(iStmt.elseStmt, i+2);
      }
      return null;
    }
    ...
    @Override
    public Void visit(Statement.ContinueStatement conStmt) {
      indent(i); sayln("continue;");
      return null;
    }

    @Override
    public Void visit(Statement.FunctionStatement funcStmt) {
      indent(i);
      say(funcStmt.varName);
      if (funcStmt.list_args == null ||
          funcStmt.list_args.size() == 0)
      {
        sayln("();");
      } 
      else 
      {
        say("(");
        int argIndex = 0;
        for (Expression arg : funcStmt.list_args) 
        {
          print(arg, i + 4);
          if (argIndex++ < funcStmt.list_args.size() - 1)
            say(", ");
        }
          sayln(");");
      }
  ...
  public static abstract class Expression extends Node {
    ...
    public interface Visitor<T> { 
      ...
      // TODO, add more here
      T visit(And expr);
      T visit(EqualRelation expr);
      T visit(Relational expr);
      T visit(Negative expr);
      T visit(Star expr); 
      T visit(Additive expr);
      T visit(Multiplicative expr);
      T visit(Func expr);
      T visit(Str expr);   
      //add more end
      T visit(Char expr); 
      T visit(Int expr); 
      T visit(Double2 expr); 
      T visit(ID expr); 
      T visit(Array expr);
    }
    ...
    public static class Star extends Unary {
      public Star(Token op, Expression expr) {
        super(op, 7, expr);
      }
      public <T> T accept(Visitor<T> visitor) { return visitor.visit(this); }
    }
    ...
    public static class And extends Binary {
     ...
     public static class EqualRelation extends Binary {
      public EqualRelation(Token tok, Expression left, Expression right) {
        super(tok, 2, left, right);
      }
      public <T> T accept(Visitor<T> visitor) { return visitor.visit(this); }
    }

    public static class Relational extends Binary {
      public Relational(Token tok, Expression left, Expression right) {
        super(tok, 3, left, right);
      }
      public <T> T accept(Visitor<T> visitor) { return visitor.visit(this); }
    }

    public static class Additive extends Binary {
      public Additive(Token tok, Expression left, Expression right) {
        super(tok, 4, left, right);
      }
      public <T> T accept(Visitor<T> visitor) { return visitor.visit(this); }
    }

    public static class Multiplicative extends Binary {
      public Multiplicative(Token tok, Expression left, Expression right) {
    ...
    public static class Str extends Expression {
      ...
      public Str(Token tok, String str) {
        super(tok, 8);
        this.str = str;
      }
    ...
    //add class by myself
    public static class Func extends Expression {
      public Token id;
      public List<Expression> list_args2;
      public Func(Token id, List<Expression> list_args2) {
        super(id, 8);
        this.id = id;
        this.list_args2 = list_args2;
    ...
    public static class Double2 extends Expression {
      public final double value;
      public Double2(Token tok, String value) {
        super(tok, 8);
        //modified by myself
        this.value = Double.parseDouble(value);
        // if (value.charAt(0) == '0' && value.length() > 1) {
        //   if (value.charAt(1) == 'x')
        //     this.value = Double.parseDouble(value.substring(2), 16);
        //   else
        //     this.value = Double.parseDouble(value.substring(1), 8);
        // } else {
        //   this.value = Double.parseDouble(value);
        // }
      }
  ...
  public static abstract class Statement extends Node {
    ...
    public interface Visitor<T> { 
      ...
      T visit(FunctionStatement funcStmt);
    }
    ...
    public static class FunctionStatement extends Statement {
      public Token id; 
      public Token varName;
      public List<Expression> list_args;
      public FunctionStatement(Token id, Token varName, List<Expression> list_args)
      {
        super(id);
        this.varName = varName;
